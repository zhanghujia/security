...
public class SmsCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    private Map<String, ValidateCode> validateCodeMaps;

    private final AntPathMatcher antPathMatcher = new AntPathMatcher();

    @Override
    public void afterPropertiesSet() {
        urls.add(SecurityConstants.MOBILE_AUTO_LOGIN);
    }
    ...
    public void validate(ServletWebRequest request) throws ServletRequestBindingException {
        ...
        SmsCode codeInSession =
                (SmsCode) sessionStrategy.getAttribute(request, SESSION_KEY_PREFIX + "SMS");

        String codeInRequest
                = ServletRequestUtils.getStringParameter(request.getRequest(), "smsCode");
